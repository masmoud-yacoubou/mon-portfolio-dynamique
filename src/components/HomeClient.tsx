...
// Description : Affiche les sections Hero, Projets, Skills, Expériences et Footer.
//               Utilise les types Prisma (remplace Sanity).
// =============================================================================
...
export default function HomeClient({
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-[#050505] text-black dark:text-white font-poppins selection:bg-blue-600 selection:text-white">
      ...
      <section className="relative min-h-[90vh] lg:min-h-screen flex items-center px-6 py-20 lg:py-0 lg:px-20">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            >
              <span className="w-8 h-[2px] bg-blue-600 hidden sm:block" />
            ...
            <motion.div variants={fadeInUp}>
              <a
                href="#works"
                className="group relative inline-flex items-center gap-4 bg-blue-600 text-white px-8 py-4 font-montserrat font-bold uppercase tracking-widest text-[10px] overflow-hidden transition-all active:scale-95"
              >
                <span className="relative z-10">{dict?.hero?.cta}</span>
                <div className="absolute inset-0 bg-black translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
                <span className="relative z-10 text-lg group-hover:rotate-45 transition-transform">
                  {"→"}
                </span>
              </a>
            </motion.div>
          ...
          >
            <div className="relative group scale-90 sm:scale-100">
              ...
              >
                <div className="text-[8px] sm:text-[10px] font-black uppercase tracking-widest text-blue-600">
                  {dict?.hero?.badge}
                </div>
      ...
      <section
        id="works"
        className="py-20 px-6 lg:px-20 max-w-7xl mx-auto border-t border-slate-100 dark:border-zinc-900"
      >
              ...
              <div className="py-6 sm:py-8 flex flex-col flex-1">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.technologies?.slice(0, 3).map((tech) => (
                    <span
                      key={tech}
                      className="text-[8px] sm:text-[9px] font-bold uppercase tracking-widest border border-slate-200 dark:border-zinc-800 px-2 sm:px-3 py-1"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="mt-auto pt-4">
                  {project.link ? (
                    <Link
                      ...
                      className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-blue-600 hover:gap-4 transition-all"
                    >
                      {dict?.projects?.view_project ?? "Voir"}
                      <span>{"→"}</span>
                    </Link>
                  ) : (
          ...
          {experiences?.map((exp) => (
            ...
            >
              <div className="md:col-span-2 text-[10px] font-black text-blue-600 uppercase tracking-widest">
                ...
                {" — "}
                {exp.endDate ? new Date(exp.endDate).getFullYear() : "PRES"}
              </div>
      ...
      <footer
        id="contact"
        className="relative pt-32 pb-16 px-6 border-t border-slate-100 dark:border-zinc-900 bg-white dark:bg-[#050505] overflow-hidden"
      >
        {/* Décoration fond */}
